...
python main.py --net lenet --dataset mnist --n_epochs_train 2 --epochs_test "2" --trial 1

# Test 2: Klasyczna sieć, standardowe dane
echo "--- Uruchamiam AlexNet na CIFAR10 ---"
python main.py --net alexnet --dataset cifar10 --n_epochs_train 2 --epochs_test "2" --trial 1

# Test 3: Głęboka sieć, standardowe dane
echo "--- Uruchamiam ResNet na CIFAR10 ---"
python main.py --net resnet --dataset cifar10 --n_epochs_train 2 --epochs_test "2" --trial 1
